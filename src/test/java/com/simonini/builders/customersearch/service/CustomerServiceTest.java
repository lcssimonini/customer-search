...
public class CustomerServiceTest {
    ...
    public void should_get_client_page() {
        ...
        when(customerRepository.findAll(null, pageRequest))
                .thenReturn(clientPage);

        Page<CustomerDTO> clientsPage = clientService.findAll(null, pageRequest);
        assertEquals(2, clientsPage.getTotalElements());

        assertArrayEquals(clientPage.get().map(CustomerDTO::from).toArray(), clientsPage.get().toArray());
    }
    ...
    public void should_not_delete_not_found() {
        ...
        doThrow(new EmptyResultDataAccessException(1))
                .when(customerRepository).deleteById(id);

        assertThrows(CustomerServiceImpl.CustomerNotFoundException.class, ()-> clientService.delete(id));
    }
    ...
    public void should_not_update_client_not_found() {
        ...
        assertThrows(CustomerServiceImpl.CustomerNotFoundException.class,
