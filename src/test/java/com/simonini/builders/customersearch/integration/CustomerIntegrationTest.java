...
import com.simonini.builders.customersearch.CustomerSearchApplication;
...
@SpringBootTest(classes = {CustomerSearchApplication.class})
...
public class CustomerIntegrationTest {
    ...
    public void should_create_and_list_all_clients() throws Exception {
        mvc.perform(get(CUSTOMERS_PATH)
                .contentType(APPLICATION_JSON)
                .accept(APPLICATION_JSON))
                .andExpect(status().is2xxSuccessful())
    ...
    public void should_delete_client() throws Exception {
        ...
        deleteCustomer(savedCustomer.getId())
                .andExpect(status().is2xxSuccessful());
    ...
    public void should_find_client_by_id() throws Exception {
        ...
        mvc.perform(get(String.format(CUSTOMERS_PATH_TEMPLATE, savedCustomer.getId()))
                .contentType(APPLICATION_JSON)
                .accept(APPLICATION_JSON))
                .andExpect(status().is2xxSuccessful())
    ...
    public void should_put_client() throws Exception {
        ...
        CreateCustomerDTO updateCustomerDTO = CreateCustomerDTO.builder()
                .name("new name")
                .document("454545")
                .birthDate(LocalDate.now())
                .build();

        mvc.perform(put(String.format(CUSTOMERS_PATH_TEMPLATE, savedCustomer.getId()))
    ...
    public void should_not_put_not_found() throws Exception {
        CreateCustomerDTO updateData = CreateCustomerDTO.builder()
                .name("new name")
                .document("454545")
                .birthDate(LocalDate.now())
                .build();

        mvc.perform(put(String.format(CUSTOMERS_PATH_TEMPLATE, 1))
    ...
    public void should_path_client() throws Exception {
        ...
        UpdateCustomerDTO patchName = UpdateCustomerDTO.builder()
                .name("new name")
                .build();

        UpdateCustomerDTO patchDocument = UpdateCustomerDTO.builder()
                .document("new document")
                .build();

        UpdateCustomerDTO patchBirthDate = UpdateCustomerDTO.builder()
                .birthDate(LocalDate.now())
                .build();

        mvc.perform(patch(String.format(CUSTOMERS_PATH_TEMPLATE, savedCustomer.getId()))
    ...
    public void should_not_patch_not_found() throws Exception {
        UpdateCustomerDTO updateData = UpdateCustomerDTO.builder()
                .name("new name")
                .build();

        mvc.perform(patch(String.format(CUSTOMERS_PATH_TEMPLATE, 1))
                .content(objectMapper.writeValueAsString(updateData))
                .contentType(APPLICATION_JSON)
                .accept(APPLICATION_JSON))
                .andExpect(status().isNotFound());
    ...
    private CustomerDTO saveCustomer(CreateCustomerDTO createCustomerDTO) throws Exception {
        String response = mvc.perform(post(CUSTOMERS_PATH)
    ...
    private ResultActions deleteCustomer(Long id) throws Exception {
        return mvc.perform(delete(String.format(CUSTOMERS_PATH_TEMPLATE, id))
                .contentType(APPLICATION_JSON)
                .accept(APPLICATION_JSON));
    }
